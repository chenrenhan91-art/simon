...
function Wordmark() {
  return <span className="wordmark">SUPER QUANTITY</span>;
}
...
export function App() {
  ...
  return <div className="site-shell">
    <a className="announcement" href="#collection">OBJECTS FOR THE EVERYDAY RITUAL — EXPLORE THE COLLECTION</a>
    ...
    <main id="top">
      ...
      <section className="story-pairs" id="about"><article><img src={asset("755670267b45bb05")} alt="Hand-finished clear glass object" /><div><h2>Made for the moment</h2><p>Considered forms and quiet details for tables that invite people to stay awhile.</p><a className="button button-outline" href="#category">EXPLORE TABLE OBJECTS</a></div></article><article><img src={asset("2f4154ed7507563f")} alt="Cocktail glasses on a serving tray" /><div><h2>Pour something good</h2><p>Glassware for weeknight rituals, dinner parties, and everything in between.</p><a className="button button-outline" href="#category">EXPLORE DRINKWARE</a></div></article></section>
      <section className="motion-section"><h2>Details in focus</h2><div className="motion-image"><img src={asset("0ed1ba2b25791f04")} alt="Atmospheric exterior view in autumn" /><div><p>DESIGNED FOR THOUGHTFUL SPACES</p><a className="button button-light" href="#contact">TALK TO US</a></div></div></section>
      ...
      <section className="contact-feature" id="contact"><img src={asset("0ed1ba2b25791f04")} alt="Autumn landscape and waterside building" /><div className="contact-overlay"><p>HONG KONG SUPER QUANTITY TECHNOLOGY CO., LIMITED</p><h2>Let's make space for the next good thing.</h2><div className="contact-details"><a href="mailto:hua75925@gmail.com">hua75925@gmail.com</a><a href="tel:+85270341654">+852 70341654</a><address>RM 12, 6/F THE CLOUD 111<br />TUNG CHAU ST, TAI KOK TSUI<br />HONG KONG</address></div></div></section>
    </main>
    <footer className="site-footer"><div className="newsletter"><h2>Stay in the loop</h2><p>Occasional notes on new objects, collections, and company news.</p><form onSubmit={(event) => { event.preventDefault(); setNewsletterStatus("Thank you — you're on the list."); }}><label className="sr-only" htmlFor="newsletter-email">Email address</label><input id="newsletter-email" type="email" required placeholder="EMAIL ADDRESS" /><button type="submit">SIGN UP</button></form>{newsletterStatus && <p className="status-message" role="status">{newsletterStatus}</p>}</div><div className="footer-grid"><div><Wordmark /><p className="footer-company">HONG KONG SUPER QUANTITY TECHNOLOGY CO., LIMITED</p></div><div><h3>COLLECTION</h3><a href="#collection">New arrivals</a><a href="#collection">Table objects</a><a href="#collection">Drinkware</a><a href="#category">All categories</a></div><div><h3>COMPANY</h3><a href="#about">About us</a><a href="#contact">Contact</a><a href="mailto:hua75925@gmail.com">Email</a><a href="tel:+85270341654">Call us</a></div><div><h3>ADDRESS</h3><p>RM 12, 6/F THE CLOUD 111<br />TUNG CHAU ST, TAI KOK TSUI<br />HONG KONG</p></div></div><div className="footer-base"><span>© 2026 HONG KONG SUPER QUANTITY TECHNOLOGY CO., LIMITED</span><span>PRIVACY · TERMS</span></div></footer>
